# bbrplus-5.16
Linux BBRplus Kernel 5.16 ported from BBRplus 4.14  
(note that it does NOT based on 5.16 version of BBR, instead just simple ported the 4.14 version of BBRplus)
<br/>
<br/>
<br/>
...
###  ii)  keep official v5.16 tcp_bbr module in the kernel, now can do either  
<br/>
...
### 1) get convert patch on this repository, use git or direct download
        (e.g., convert_official_linux-5.16.x_src_to_bbrplus.patch)
...
### 3) extract the tarball & cd extracted directory
        tar xvf linux-5.16.10.tar.xz && cd linux-5.16.10
...
### 4) copy convert patch to extracted kernel directory
        something like
            cp ../convert_official_linux-5.16.x_src_to_bbrplus.patch .

<br/>
<br/>

### 5) do the patch job
        patch -p1 < convert_official_linux-5.16.x_src_to_bbrplus.patch
